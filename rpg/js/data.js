...
DATA.maps.castle = {
  ...
  npcs: [
        ...
        { cond: { flag: "leonEp2" },
          then: [
            { cond: { flag: "trueClear" },
              then: [
                { cond: { flag: "leonEp3" },
                  then: [{ msg: "ろうきし「剣を おさめてなお つよく あれ。\nそなたは わしの ほこりじゃ」" }],
                  else: [
                    { msg: "ろうきし「すべてが おわったのだな。\n星の 光が やさしいのが\nなによりの あかしじゃ」" },
                    { msg: "「最後に ひとつだけ。 剣は ふるうより\nおさめる ほうが むずかしい。\nそなたは もう その意味を しっておろう」" },
                    { msg: "レオン「はい。 この 平和を まもるために\nこれからも つよく あります」" },
                    { msg: "ろうきし「みごとな こころがまえじゃ。\nわしの 剣のけいけん、すべて さずけよう」" },
                    { prof: ["leon", 10] },
                    { msg: "レオンの熟練度が 10 あがった!" },
                    { flag: ["leonEp3", 1] },
                  ] },
              ],
              else: [{ msg: "ろうきし「そなたの ちちうえも きっと\nほこりに おもっておられる。\nよい かおに なったな、レオンどの」" }] },
          ],
          else: [
    ...
    { id: "king", x: 9, y: 1, spr: "king",
      script: [
        { cond: { flag: "clear" },
          then: [{ msg: "ヴェルダおう「レオンよ……\nこのくには おまえたちに すくわれた。\n心から れいを いう」" }],
          else: [
            { cond: { flag: "paladin" },
              then: [{ msg: "ヴェルダおう「……力が…… みなぎる……\nくくく…… こい レオン……\nまてんろうで まっているぞ……」" }],
              else: [{ msg: "ヴェルダおう「クリスタルは まだか!\nはやく うばってくるのだ!\nこれは めいれいだ!!」" }] },
          ] },
      ] },
                ...
                { cond: { flag: "celiaEp2" },
                  then: [
                    { cond: { flag: "trueClear" },
                      then: [
                        { cond: { flag: "celiaEp3" },
                          then: [{ msg: "シスター「いのりの 道に おわりは ないわ。\nいっしょに あるきましょう」" }],
                          else: [
                            { msg: "シスター「星の 光が もどった夜、\nむらの みんなで おいのりを したのよ」" },
                            { msg: "セリア「わたしの いのりは、みんなの\nいのりに ささえられて いたんですね」" },
                            { msg: "シスター「ええ、だから もう だいじょうぶ。\n……さあ、だいだいに つたわる\n呼吸法を おしえるわね」" },
                            { prof: ["celia", 10] },
                            { msg: "セリアの熟練度が 10 あがった!" },
                            { flag: ["celiaEp3", 1] },
                          ] },
                      ],
                      else: [{ msg: "シスター「あなたの いのりは もう\nわたしの てを はなれて、世界中を\nてらしているのね」" }] },
                  ],
                  else: [
        ...
        { cond: { flag: "gouEp2" },
          then: [
            { cond: { flag: "trueClear" },
              then: [
                { cond: { flag: "gouEp3" },
                  then: [{ msg: "しのまぼろし「きわみに おわりは ない。\nそれが 拳の 道じゃ」" }],
                  else: [
                    { msg: "しのまぼろし「……みごとじゃった。\nおまえの 拳は 星さえ 守りぬいた」" },
                    { msg: "ゴウ「ししょう…… おれ、まだ\nつよく なれますか」" },
                    { msg: "しのまぼろし「なれる。 きわみに おわりは ない。\nわしの 最後の 呼吸、さずけよう」" },
                    { prof: ["gou", 10] },
                    { msg: "ゴウの熟練度が 10 あがった!" },
                    { flag: ["gouEp3", 1] },
                  ] },
              ],
              else: [{ msg: "しのまぼろし「拳は 心。\nもう おしえることは なにもない。\nいけ、ゴウ」" }] },
          ],
          else: [
            { msg: "ほのかな 光が ひとのかたちに……。\nゴウ「……ししょう!? まさか……」" },
...
DATA.maps.icecave = {
  ...
  chests: [
    { id: "ice_wall", x: 10, y: 4, gold: 3000, hidden: true },
...
DATA.maps.portinn = {
  ...
  npcs: [
    { id: "rumor_lover", x: 2, y: 5, spr: "villager", wander: true,
      script: [
        { msg: "うわさずきのモグ「よう、いっぱい やってるか?\nおもしろい うわさを きかせてやるよ」" },
        { rumor: true },
      ] },
    { id: "slot_geezer", x: 7, y: 2, spr: "villager", pal: "dark",
      script: [
        { msg: "スロットじいさん「へっへっへ、\nみなとの 男の あそびと いえば こいつよ。\n1かい 100ギル。 ごうけつは ←→で 500ギルだ」" },
        { menu: { options: [
                ...
                { cond: { flag: "rodEp2" },
                  then: [
                    { cond: { flag: "trueClear" },
                      then: [
                        { cond: { flag: "rodEp3" },
                          then: [{ msg: "ガレフ「まなびの 道に おわりは ない。\nまた こい、ロッド」" }],
                          else: [
                            { msg: "ガレフ「星の塔の 魔導きろくを よんだぞ。\nでしの ろんぶんを よむ きぶんだ」" },
                            { msg: "ロッド「はずかしいから やめてくださいよ。\n……でも、まだ わからないことだらけです」" },
                            { msg: "ガレフ「それでいい。 『わからない』こそ\n魔導の はじまりだ。 わしの 詠唱のこつ、\nすべて もっていけ」" },
                            { prof: ["rod", 10] },
                            { msg: "ロッドの熟練度が 10 あがった!" },
                            { flag: ["rodEp3", 1] },
                          ] },
                      ],
                      else: [{ msg: "ガレフ「『こえてみせる』と いった でしに\nこえられる ひが くるとはな。\n……わるくない きぶんだ」" }] },
                  ],
                  else: [
...
DATA.maps.twine = {
  ...
  npcs: [
    ...
    { id: "quizmaster", x: 8, y: 9, spr: "elder", pal: "light",
      script: [
        { cond: { flag: "quiz2Done" },
          then: [{ msg: "クイズマスター「上級編まで せいはした きみは\nもはや いきる クイズ殿堂……。\nわたしが ならいたい くらいだよ」" }],
          else: [
            { cond: { flag: "quizDone" },
              then: [{ runScript: "quizAdvanced" }],
              else: [{ runScript: "quizBasic" }] },
          ] },
      ] },
...
DATA.maps.halloffame = {
  ...
  npcs: [
    ...
    { id: "hall_scribe", x: 11, y: 7, spr: "villager", pal: "light",
      script: [
        { msg: "きろく係「ここには 7つの章の あゆみが\nしるされています。 ごらんに なりますか?」" },
        { recap: true },
      ] },
                  ...
                  then: [{ msg: "図鑑はかせ「100種は こえたな。\nのこりの 魔物は てごわいぞ。\n全165種、まっておるぞ!」" }],
                    ...
                    { cond: { bestiaryKilled: 100 },
                      then: [
                        ...
                        { cond: { flag: "zukan50" },
                          then: [{ msg: "図鑑はかせ「つぎは 100種じゃ。\n世界の すみずみまで あるくのじゃぞ」" }],
                          else: [
                            { cond: { bestiaryKilled: 50 },
                              then: [
                                { msg: "図鑑はかせ「ほう、討伐 50種ごえか。\nみこみが あるのう。\nこれは はげみじゃ」" },
                                { give: { gold: 5000 } },
                                { msg: "5000ギルを 手に入れた!" },
                                { flag: ["zukan50", 1] },
                              ],
                              else: [
                                { msg: "図鑑はかせ「わしは 魔物図鑑の けんきゅうか。\n討伐 50種、100種、そして 全150種に\nほうびを よういしておる」" },
                                { msg: "「図鑑で 討伐ずみの かずを\nかぞえてみると よいぞ」" },
                              ] },
                          ] },
                      ] },
                ...
                { cond: { flag: "glenEp2" },
                  then: [
                    { cond: { flag: "trueClear" },
                      then: [
                        { cond: { flag: "glenEp3" },
                          then: [{ msg: "ガロン「たかみに 上限は ねえ。\nまた やりあおうぜ、竜騎士」" }],
                          else: [
                            { msg: "ガロン「星の塔の てっぺんまで いったか。\nやまの 上から あの 光を みていたぞ」" },
                            { msg: "グレン「あんたとの けいこが なければ\nおれの やりは とどかなかった。\n……れいを いわせてくれ」" },
                            { msg: "ガロン「よせよせ。 それより さいごの\nけいこだ。 おれの 呼吸、ぬすんでいけ!」" },
                            { prof: ["glen", 10] },
                            { msg: "グレンの熟練度が 10 あがった!" },
                            { flag: ["glenEp3", 1] },
                          ] },
                      ],
                      else: [{ msg: "ガロン「やりの 風が かわったな。\n守る ものが ある やつの かぜだ。\nいつでも うちに こい」" }] },
                  ],
                  else: [
...
// ものがたりのきろく (でんどうのまで読める章のあらすじ)
DATA.storyRecap = [
  { title: "第一章  地上編", lines: [
    "ヴェルダ王の命で ネブラの村から",
    "クリスタルを うばった 暗黒騎士レオン。",
    "だが 王は 魔皇ザルバに あやつられていた。",
    "心のほこらの 試練で 光の騎士となり、",
    "魔天楼の けっせんで ザルバを うちやぶる。",
  ] },
  { title: "第二章  地底編", lines: [
    "大穴の そこに ひろがる 地底世界。",
    "鍛冶の里ムスペルの ドワーフたちと であい、",
    "地底神殿で 「地のクリスタル」を まもりぬく。",
  ] },
  { title: "第三章  天空編", lines: [
    "ドワーフが なおした 飛空艇シリウス号で",
    "大空へ。 空の島の 風の神殿にて",
    "「風のクリスタル」を 手にする。",
  ] },
  { title: "第四章  深海編", lines: [
    "潜水装置を くみこんだ シリウス号で",
    "大うずしおの したへ。 海底神殿の",
    "リヴァイアを しずめ 「水のクリスタル」を。",
    "4つが そろうも 星の塔は ひらかない……。",
  ] },
  { title: "第五章  新大陸編", lines: [
    "世界各地に 立ちのぼる 災いのもや。",
    "東の大陸の 鏡のぬし、氷の列島の 氷結の女神、",
    "砂の王国の よみがえりし王 ——",
    "3つの 災いを 旅の 拳と 剣が しずめていく。",
  ] },
  { title: "第六章  常夜編", lines: [
    "緑の群島の 守り神、雷鳴の島の 雷神をしずめ、",
    "朝の こない 夜の国へ。 大聖堂の おくで",
    "かなしみに のまれた 女王ノクティアを すくうと",
    "星の塔の 封印が とけた。",
  ] },
  { title: "第七章  星の塔編", lines: [
    "よぞらに のびる 光の塔。 そのいただきで",
    "すべての 災いの 元凶 星くらいヴォイドスと",
    "さいごの たたかいへ。",
  ] },
  { title: "よりみちの きろく", lines: [
    "闘技場の 5つの ランク、3つの つりば、",
    "60をこえる 隠し宝箱、5ひきの ねこ、",
    "150種の 魔物、11の 実績 ——",
    "世界は よりみちで できている。",
    "つかれたら スロットと おみくじも どうぞ。",
  ] },
  { title: "そして 伝説へ", lines: [
    "光が もどった 世界。 5人の 騎士たちの",
    "名は クリスタルナイツとして",
    "永遠に 語りつがれる ——",
    "",
    "だが 世界には まだ 隠された 迷宮、",
...
// 酒場のうわさばなし (ヒントと裏技の匂わせ)
DATA.rumors = [
  "「ヴェルダ城の 玉座のまには 王家のへそくりが\n2つも あるらしいぜ。 王様の すぐ横も\nあやしいってさ」",
  "「にしの洞窟の 左上の 岩壁、\nすりぬけられる ばしょが あるって\nうわさだ。 ほんとかね?」",
  "「タイトルがめんで クリスタルの かたちに\n十字キーを 2かい なぞると……\nおっと、これいじょうは いえねえ」",
  "「長老の家の いちばん左の 本棚、\n世界を すくった あとに しらべると\nなにかが あるらしい」",
  "「ネブラの村の おみくじ、ボスの まえに\nひくと いいらしいぜ。 大吉なら\nひっさつゲージが はんぶん たまるとか」",
  "「夜の国の 西の 岸辺で 夜釣りが できる。\nよるのぬしは 6000ギルの おおものだ」",
  "「熟練度ってのは 戦闘で 4回 うごくたびに\n1あがる。 闘技場まえの 師範が\n節目に ほうびを くれるぜ」",
  "「セレーネの 店には 35万ギルの 腕輪と\n50万ギルの 羽飾りが あるらしい。\nダイヤモンドランクで かせぐしか ねえな」",
  "「全地域の ぬしを しずめると 北の空に\nまぼろしの しろが あらわれるって\nじいさんが いってた」",
  "「魔物図鑑を 150種 ぜんぶ うめて\nでんどうのまの はかせに みせると\nすごい ほうびが もらえるらしい」",
  "「トワインの クイズマスターの 3もんクイズ、\nこたえは ぜんぶ 物語の なかに あるぜ」",
  "「ほしのはかの さいしんぶには 星々の王が\nねむってる。 経験値 50000の ばけものだ」",
  "「宿屋の スロット、リールが とまる\nしゅんかんを よく みてると……\nいや、ただの うんだよ、うん」",
  "「果実で HPを あげるなら はやいうちが\nいいぜ。 じゅくれんども こつこつとな」",
  "「かくれた ぶきは 5つ。 ぬま釣り、闘技場、\nさいだん、時の頂上、そして えいゆうのあかし。\nかたりべが くわしいぜ」",
  "「クエストちょうで 十字キーの よこを おすと\n『ぼうけんのきろく』が みられるって\nしってたか?」",
  "「後列に さげた 仲間は 物理を もらいにくい。\n魔法つかいは 後列が てっぱんだ」",
  "「ぜんめつしても オートセーブから\nつづけられる じだいに なったもんだ。\nいい じだいだぜ」",
  "「トワインの クイズに ぜんもん せいかいすると\nほうびが でるらしい。 こたえは ぼうけんの\nなかに あるとさ」",
  "「でんどうのまの きろく係に たのむと\nこれまでの 物語を ふりかえれるぜ。\nなつかしくて なみだが でらあ」",
  "「すりぬけられる 壁は にしの洞窟だけじゃ\nないらしい。 氷の洞窟の まんなかへんの\n壁も あやしいって もっぱらの うわさだ」",
  "「クイズ大会を せいはすると 上級編が\nはじまるらしいぜ。 5もん れんぞくの\n超difficultってやつだ」",
  "「図鑑はかせは 50種、100種でも\nほうびを くれるらしい。 こまめに\nかおを だすと いいぜ」",
  "「せっていの『たびのこころえ』に\nよくある しつもんが のってるぜ。\nこまったら よんでみな」",
  "「スロットで 777を だすと 画面が\nキラキラ ひかるらしい。 みたやつは\nまだ すくないがな」",
  ...
  "「開発室には 完成きねんの きねんひが\nあるらしい。 つくったやつらの きもちが\nつまってるとさ。 いいはなしだ」",
  "「レベルアップの ときに どの能力が\nいくつ あがったか でるように なった。\nこまかい ところに きが きくねえ」",
  "「セーブの スロットには いま なん章かも\nでるんだぜ。 むかしは そんなの\nなかったもんだ」",
  "「げんかいかいほうは 1戦闘 1回きり。\nきりふだは ここぞって ときに きれよ」",
  "「かえんの 洞窟には 火の粉が まって、\n夜の国には 星が ふる。 たまには\nたちどまって ながめて みなよ」",
  "「でんどうのまの きろく係の さいごの\nページには 『よりみちのきろく』が\nあるんだと。 しゃれてるねえ」",
  "「この 世界の うわさは これで 30こめ。\nぜんぶ きいた きみは そうとうの\nうわさずきだね。 かんぱい!」",
  "「……え? おれの うわさ? おれは ただの\nモグさ。 みなとの 酒場で いっぱい やるのが\nしあわせな、ただの モグ」",
  "「クリスタルナイツの ぼうけんは 15000行。\nつくった やつらも あそんだ きみも\nみんな えらい! かんぱーい!!」",
];

// たびのこころえ (ゲーム内ヘルプ)
DATA.helpPages = [
  { title: "そうさの きほん", lines: [
    "矢印キー/WASD … いどう・カーソル",
    "Z/Enter/Space … けってい・しらべる",
    "X/Esc … キャンセル・メニュー",
    "Mキー … サウンドの ON/OFF",
    "",
    "スマホは 画面の 十字パッドと",
  ...
  { title: "戦闘の こころえ", lines: [
    "ATBゲージが たまった 仲間から 行動。",
    "ウェイトなら コマンドちゅうは 敵も待つ。",
    "後列は 物理ダメージを 与も被も半減。",
    "被弾で ひっさつゲージが たまり、",
    "100%で「ひっさつ!」が つかえる。",
    "敵の 弱点は 図鑑に きろくされる。",
  ...
  { title: "せいちょうの こころえ", lines: [
    "経験値は 生きのこった 全員に 満額。",
    "戦闘で 4回 行動するたび 熟練度+1。",
    "熟練度は キャラごとに 違う能力が のび、",
    "師範 (ソレイユ) が 節目に ほうびをくれる。",
    "生命/魔力の果実は 永続で HP/MPアップ。",
    "レベルアップで 呪文も おぼえていく。",
  ] },
  { title: "たんさくの こころえ", lines: [
    "メニューの「ちず」で 現在地を かくにん。",
    "あやしい 足元や 壁際は「しらべる」!",
    "隠し宝箱が 世界の あちこちに ねむる。",
    "つりばは 空の島・湖・夜の国の 3か所。",
    "ネブラの村の おみくじで 運だめしも。",
  ...
  { title: "よくある しつもん", lines: [
    "Q. 敵が つよすぎる!",
    "A. 後列を つかい、宿で 回復。 熟練度を",
    "   ためつつ レベルを あげよう。",
    "Q. お金が たりない!",
    "A. 闘技場と ぬし釣りが かせぎどころ。",
    "   王家のへそくりの うわさも……。",
    "Q. つぎに どこへ いけば?",
    "A. クエストちょうの「つぎのもくてき」を!",
  ] },
  { title: "よくある しつもん・2", lines: [
    "Q. ボスに かてない!",
    "A. 図鑑で 弱点を チェック。 プロテスと",
    "   ヘイストの 補助も わすれずに。",
    "Q. MPが すぐ きれる!",
    "A. エーテルは 惜しまず。 魔力の果実で",
    "   最大MPを のばす てもある。",
    "Q. 隠しようそは どこ?",
    "A. 酒場の モグが うわさを しっている。",
  ] },
  { title: "こまったときは", lines: [
    "全滅しても「つづきから」で オートセーブ",
    "地点から すぐ 再開できる。",
    "ザコ戦が つらければ コンフィグで",
    "エンカウントOFFに できる。",
    "ダンジョンからは「帰還の翼」で 脱出。",
    "セーブは こまめに、スロットは 4+1つ。",
    "パスワードで 端末の ひっこしも できる。",
    "それでも だめなら 宿で ひとやすみ。",
    "あすの ぼうけんは きっと うまくいく。",
  ] },
];
...
DATA.maps.devroom = {
  ...
  npcs: [
    { id: "dev_sales", x: 11, y: 3, spr: "villager",
      script: [
        { msg: "えいぎょうのゴル「この ゲームの みどころは\nですね、まず 全7章の 物語!\nそれから 熟練度に 裏技に……」" },
        { msg: "「……と、ここまで あそんでくれた きみに\nいまさら せつめいは いらないか。\nありがとう、また あそんでね!」" },
      ] },
    { id: "dev_mop", x: 4, y: 5, spr: "slime", pal: "light", wander: true,
      script: [
        { msg: "そうじがかりのモップ「プルプル。 ここは\n物語の そとがわだから、まものも\nそうじがかりに なれるんだ。 プル」" },
        { msg: "「バグバグ先輩に あこがれてる。\nいつか おれも バグを たべて みたい。\n……でない ほうが いいんだけどね」" },
      ] },
    { id: "dev_sign", x: 6, y: 5, spr: "crystal",
      script: [
        { msg: "きねんひ「クリスタルナイツ 完成 きねん」" },
        { msg: "「あそんでくれた すべての ぼうけんしゃに\nさいだいきゅうの かんしゃを こめて。\n—— かいはつしつ いちどう より」" },
      ] },
    { id: "dev_dir", x: 4, y: 2, spr: "elder",
      script: [
        { msg: "ディレクターのクリフ「ようこそ 開発室へ!\nここは 物語の そとがわ。\nくつろいで いってくれたまえ」" },
        { msg: "「5章で 完成の よていが、きがつけば\n7章だ。 スタッフは みな 白目だが\nわたしは まんぞくして いる!」" },
        { msg: "「きみの セーブデータには 15000ぎょうぶんの\nぼうけんが つまっている。\nどうか さいごまで たのしんでくれ」" },
      ] },
    { id: "dev_dot", x: 8, y: 2, spr: "villager", pal: "light",
      script: [
        { msg: "ドッターのテンテン「この 世界の ぜんぶは\n8x8の ドットで できてるの。\nヤシの木、なんど うちなおしたか……」" },
        { msg: "「4しょくしか つかえないのに\n『夜っぽく』とか いわれるのよ?\nでも できちゃうのが ドットのミラクル!」" },
        { msg: "「おきにいりは 不死鳥の羽飾りの アイコン。\n……え、アイコンは ないって?\nこころの めで みて!」" },
      ] },
    { id: "dev_snd", x: 2, y: 4, spr: "villager", pal: "dark", wander: true,
      script: [
        { msg: "サウンドのオクタ「BGMは ぜんぶ 2声の\nチップチューン。 3声めが ほしいと\nいったら よさんが なかった」" },
      ] },
    { id: "dev_drum", x: 1, y: 4, spr: "villager", pal: "dark", wander: true,
      script: [
        { msg: "打楽器のドン「ドン、ドドン。 おれの ドラムは\nぜんぶ ノイズチャンネルさ。\nドン、ドドドン」" },
        { msg: "「タイトルがめんで クリスタルを 2かい\nなぞって おんがくかんに おいでよ。\nおれの ドラム、きけるぜ。 ドドン」" },
      ] },
    { id: "dev_bug", x: 10, y: 4, spr: "slime", wander: true,
      script: [
        { msg: "デバッガーのバグバグ「ボクが この 世界の\nバグを ぜんぶ たべました。\nプルプル。 ……ぜんぶ、たべたよね?」" },
      ] },
    { id: "dev_test", x: 3, y: 5, spr: "villager", pal: "light", wander: true,
      script: [
        { msg: "テスターのプレイ子「わたし、この 世界を\n487かいも クリアしてるんです。\nポーションの ざいこまで おぼえました」" },
        { msg: "「あなたの ぼうけんに バグが ないのは\nたぶん わたしの おかげ。\n……たぶん、ですけどね!」" },
      ] },
    { id: "dev_loc", x: 9, y: 5, spr: "villager", wander: true,
      script: [
        { msg: "ことばがかりのコトバ「セリフの 漢字と\nかなの バランス、きづいて くれました?\nレトロの あじって やつです」" },
      ] },
...
DATA.scripts = {
  ...
  quizBasic: [
    { msg: "クイズマスター「わが 3もんクイズに\nぜんもん せいかいすれば ほうびを しんぜよう。\nだい1もん!」" },
    { msg: "「世界に ちらばる クリスタルは\nぜんぶで いくつ?」" },
    { menu: { options: [
      { label: "3つ", ops: [{ msg: "「ぶっぶー! しゅぎょうして でなおしたまえ!」" }] },
      { label: "4つ", ops: [
        { msg: "「せいかい! だい2もん。\nきみたちの ひこうせんの なまえは?」" },
        { menu: { options: [
          { label: "ペガサスごう", ops: [{ msg: "「ぶっぶー! じぶんの ふねだろう!?」" }] },
          { label: "シリウスごう", ops: [
            { msg: "「せいかい! さいごの もんだい。\n夜の国を おさめる 女王の なは?」" },
            { menu: { options: [
              { label: "グラシエラ", ops: [{ msg: "「ぶっぶー! それは ひょうがの めがみ!」" }] },
              { label: "ノクティア", ops: [
                { msg: "クイズマスター「ぜんもん せいかい!!\nきみこそ 真の 物知り! ほうびを うけとりたまえ!」" },
                { give: { gold: 5000 } },
                { give: { item: "elixir" } },
                { msg: "5000ギルと エリクサーを 手に入れた!" },
                { flag: ["quizDone", 1] },
              ] },
              { label: "ルナヴォラ", ops: [{ msg: "「ぶっぶー! それは クレーターの ぬし!」" }] },
            ] } },
          ] },
          { label: "ホシマルごう", ops: [{ msg: "「ぶっぶー! かわいいが ちがう!」" }] },
        ] } },
      ] },
      { label: "5つ", ops: [{ msg: "「ぶっぶー! しゅぎょうして でなおしたまえ!」" }] },
    ] } },
  ],
  quizAdvanced: [
    { msg: "クイズマスター「チャンピオンよ、まっていた!\n上級編 5もん れんぞくだ。 だい1もん!\n王家のへそくりは ぜんぶで いくつ?」" },
    { menu: { options: [
      { label: "1つ", ops: [{ msg: "「ぶっぶー! 玉座のまを もっと しらべたまえ!」" }] },
      { label: "2つ", ops: [
        { msg: "「せいかい! だい2もん。\n闘技場の さいじょうい ランクは?」" },
        { menu: { options: [
          { label: "プラチナ", ops: [{ msg: "「ぶっぶー! そのうえが あるのだ!」" }] },
          { label: "ダイヤモンド", ops: [
            { msg: "「せいかい! だい3もん。\nクリスタルナイツは なんにん?」" },
            { menu: { options: [
              { label: "4にん", ops: [{ msg: "「ぶっぶー! なかまを わすれるな!」" }] },
              { label: "5にん", ops: [
                { msg: "「せいかい! だい4もん。 師範が ほうびを\nくれる 熟練度の さいしょの 節目は?」" },
                { menu: { options: [
                  { label: "25", ops: [
                    { msg: "「せいかい! さいごの もんだい!\n図鑑はかせが まちのぞむ 討伐数は?」" },
                    { menu: { options: [
                      { label: "100種", ops: [{ msg: "「ぶっぶー! それは ちゅうかん! おしい!!」" }] },
                      { label: "150種", ops: [
                        { msg: "クイズマスター「ぜんもん せいかい!!!\n上級編 せいは、あっぱれ!!\nこれが さいごの ほうびだ!」" },
                        { give: { gold: 10000 } },
                        { give: { item: "fruit_mana" } },
                        { msg: "10000ギルと 魔力の果実を 手に入れた!" },
                        { flag: ["quiz2Done", 1] },
                      ] },
                    ] } },
                  ] },
                  { label: "50", ops: [{ msg: "「ぶっぶー! もっと はやい 節目が ある!」" }] },
                ] } },
              ] },
            ] } },
          ] },
  ...
  arenaEntry: [
    ...
    { menu: { options: [
      ...
      { label: "ダイヤ20000G", ops: [
        { cond: { flag: "trueClear" },
          then: [
            { payGold: { amount: 20000,
              ok: [
                { msg: "うけつけ「ダイヤモンドランク……!!\n世界を すくった あなたに おくる\nさいきょうの まぼろし 3れんせんだ!!」" },
                { battle: { group: ["vaha"], boss: true, music: "boss" } },
                { battle: { group: ["regalia"], boss: true, music: "boss" } },
                { battle: { group: ["granstella"], boss: true, music: "spirit" } },
                { msg: "うけつけ「……ことばが でないよ。\nあんたたちは 闘技場 はじまって いらいの\n大チャンピオンだ!!!」" },
                { give: { gold: 100000 } },
                { give: { item: "fruit_life" } },
                { give: { item: "fruit_mana" } },
                { msg: "100000ギルと 生命の果実、魔力の果実を\n手に入れた!" },
                { flag: ["arenaDiamond", 1] },
              ],
              ng: [{ msg: "うけつけ「お金が たりないよ!」" }] } },
          ],
          else: [{ msg: "うけつけ「ダイヤモンドは 世界を すくった\n者だけの ランクさ。 ……その ひが くるのを\nまってるよ」" }] },
      ] },
      { label: "やめる", ops: [] },
    ] } },
  ],
    ...
    { cond: { flag: "airship" },
      then: [
        ...
        { cond: { flag: "submarine" },
          then: [
            { menu: { options: [
              { label: "ヴェルダ城", ops: [{ warp: { map: "world", x: 7, y: 27, dir: "d" } }] },
              { label: "ネブラのむら", ops: [{ warp: { map: "world", x: 27, y: 23, dir: "d" } }] },
  ...
  intro: [
    { chapter: "第一章  地上編" },
    { msg: "ヴェルダおう「暗黒騎士 レオンよ。\nネブラのむらの 長老がもつ\nクリスタルを うばってくるのだ」" },
    { msg: "レオン「……なぜ クリスタルを?\nネブラのむらは 平和な むらです」" },
    { msg: "ヴェルダおう「たみを 守るためだ。\nゆけ! これは めいれいだ!!」" },
    { msg: "レオン(……おうは かわられた。\nだが きしである わたしに\nめいれいに そむくことは できぬ……)" },
