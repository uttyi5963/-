...
DATA.maps.twine = {
  ...
  npcs: [
    ...
    { id: "quizmaster", x: 8, y: 9, spr: "elder", pal: "light",
      script: [
        { cond: { flag: "quizDone" },
          then: [{ msg: "クイズマスター「きみは わが クイズ大会の\n殿堂いりチャンピオンだ。\nまた あそびに きてくれたまえ」" }],
          else: [
            { msg: "クイズマスター「わが 3もんクイズに\nぜんもん せいかいすれば ほうびを しんぜよう。\nだい1もん!」" },
            { msg: "「世界に ちらばる クリスタルは\nぜんぶで いくつ?」" },
            { menu: { options: [
              { label: "3つ", ops: [{ msg: "クイズマスター「ぶっぶー! ざんねん!\nしゅぎょうして でなおしたまえ!」" }] },
              { label: "4つ", ops: [
                { msg: "クイズマスター「せいかい! では だい2もん。\nきみたちの ひこうせんの なまえは?」" },
                { menu: { options: [
                  { label: "ペガサスごう", ops: [{ msg: "クイズマスター「ぶっぶー! ざんねん!\nじぶんの ふねだろう!?」" }] },
                  { label: "シリウスごう", ops: [
                    { msg: "クイズマスター「せいかい! さいごの もんだい。\n夜の国を おさめる 女王の なは?」" },
                    { menu: { options: [
                      { label: "グラシエラ", ops: [{ msg: "クイズマスター「ぶっぶー! それは\nひょうがの めがみ! おしい!」" }] },
                      { label: "ノクティア", ops: [
                      ...
                      { label: "ルナヴォラ", ops: [{ msg: "クイズマスター「ぶっぶー! それは\nクレーターの ぬし! おしい!」" }] },
                    ] } },
                  ] },
                  { label: "ホシマルごう", ops: [{ msg: "クイズマスター「ぶっぶー! ざんねん!\nかわいい なまえだが ちがう!」" }] },
                ] } },
              ] },
              { label: "5つ", ops: [{ msg: "クイズマスター「ぶっぶー! ざんねん!\nしゅぎょうして でなおしたまえ!」" }] },
            ] } },
          ] },
      ] },
